angular.module('app.controllers')
        .controller('searchExampleCtrl', function ($scope, specService, WebService, $ionicPlatform, $state, profileService, gradeService) {
            ...
            $scope.search = function () {
                ...
                if ($scope.spec != null && $scope.pid != null && $scope.gender != null && $scope.grade != null) {
                    ...
                    alert("Please select searchExample");
                }
            };
            ...
            $scope.minorSpe = function (spe_id) {
                ...
                WebService.wepServiceConnector(data, "getMinorsearchExample", false).then(function (result) {
                    ...
                    if (minor_specialization.length == 0) {
                        ...
                        $state.go("minorsearchExample", {myParam: minor_specialization, patientId: $scope.selectedPatient});
                    }
                });
            };
        });